...
\begin{competences}[10em]
  \comptence{Operating Systems}{
    \icon{\faLinux} Linux (6 years)
  }
  \comptence{Programming}{%
    C++, Rust, Scala, Javascript, Python, SQL, \LaTeX
  }
  \comptence{Tools}{%
    SSH, Git, CMake, Vim
  }
  ...
  \comptence{\icon{\faHtml5} Web Development}{%
    Flask, FastAPI, Django, React, NextJS
  }
